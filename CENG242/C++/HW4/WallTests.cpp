...
int main(int argc, char* argv[]) {
	...
	Particle* p0 = new Particle(0,0); // 0 0 yorumlar orjinal deger
	Particle* p1 = new Particle(0,3); // 0 3
	Particle* q0 = new Particle(0,3); // 0 3
	Particle* q1 = new Particle(0,5); // 0 5
...
/**********************************************************my tester*****************************************************************/
	cout<<" Angle: "<<wallp->FindAngleBetween(*wallq)<<endl;
