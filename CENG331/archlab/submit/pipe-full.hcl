...
# MODIFICATIONS
# I implemented iaddq instruction in here to make processor run faster and
# and make quicker calculations. Because processors make faster calculations
# with constants.
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, IIADDQ, IJMPQ } : D_rB;
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ, IIADDQ, IJMPQ} : D_rB;
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
